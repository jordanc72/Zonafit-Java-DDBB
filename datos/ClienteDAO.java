...
public class ClienteDAO implements IClienteDAO {
    ...
    public List<Cliente> listarClientes() {
        ...
        //Nos permite preparar el tipo de sentencia SQL
...
//costos a mercaderia ==  CONT
    @Override
    public boolean agregarCliente(Cliente cliente) {
        PreparedStatement ps;
        //No usamos el result set xq no recumeramos info
        Connection con = getConexion();
    ...
    public boolean eliminarCliente(Cliente cliente) {
        ...
        try{
            ...
            System.out.println("Error al elimir el cliente: " + e.getMessage());
        }
        finally{
            try{
                con.close();
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        //Modificar cliente
        /*
        var modificarCliente = new Cliente("Carlos Daniel", "Ortiz", 300,4);
